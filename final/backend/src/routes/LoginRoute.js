...
const { loginAdmin, loginColab, isAdmin, getIdAdmin, getIdColab, getId } = require('../controllers/Login.controllers');
        ...
        try {
            ...
            if (isAdminResult) {
                ...
                if (loginResult) {
                    ...
                    //const userIdaaaa = await getId(req, res);
                    //console.log(userIdaaaa);
